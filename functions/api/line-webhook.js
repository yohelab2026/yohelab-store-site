...
function copilotInstructions() {
  return [
    ...
    "Keep public copy focused on よへラボ, AI news, article structure, blog operations, and sales-page notes.",
    ...
    "Do not use copyrighted stock images. Prefer lightweight original SVG/WebP/HTML-rendered diagrams that match よへラボ.",
...
const FIELD_OPTIONS = {
  "読む人": ["ブログ初心者", "個人事業主", "比較記事を書く人", "商品紹介記事を書く人", "小さなサービス販売者", "ブログ再開組", "AI文章を使う人", "サイトを軽くしたい人", "FAQを増やしたい人", "おまかせ"],
  "画像数": ["0枚", "1枚", "3枚", "5枚", "おまかせ"],
  "画像タイプ": ["アイキャッチ", "図解", "操作イメージ", "比較表風", "カード風", "おまかせ", "なし"],
  "画像の雰囲気": ["よへラボっぽく", "やわらかい", "実務寄り", "シンプル", "明るめ", "落ち着き", "おまかせ", "なし"],
  "画像の入れ方": ["冒頭だけ", "セクションごと", "本文内に自然に", "最後にまとめ", "おまかせ", "なし"],
  "文字量": ["短め", "標準", "長め", "かなり詳しく", "おまかせ"],
  "CTA": ["問い合わせ", "ブログ一覧", "関連記事を読む", "トップへ戻る", "なし", "おまかせ"],
  "対象URLまたは記事名": ["AI検索向けFAQと出典", "比較記事テンプレート", "商品ページ失敗例", "記事メーカーの使い方", "ブログ一覧から選ぶ", "おまかせ", "その他URL入力"],
  "目的": ["売上", "分かりやすさ", "SEO/AIO", "デザイン", "古い情報修正", "読みやすく", "導線改善", "おまかせ"],
  "画像追加": ["なし", "1枚", "3枚", "おまかせ"],
  "残したい表現": ["今の見出し", "価格訴求", "AI検索時代の表現", "よへラボの名前", "やわらかい文体", "なし", "その他入力"],
  "消したい表現": ["強すぎる効果保証", "売り手目線", "古い商品名", "長すぎる説明", "なし", "その他入力"],
  "宣伝したいもの": ["ブログ", "記事メーカー", "今日の更新", "問い合わせ", "おまかせ"],
  "投稿数": ["1投稿", "3投稿", "5投稿", "10投稿", "スレッド案", "おまかせ"],
  "トーン": ["やわらかめ", "強め", "実務寄り", "開発ログ風", "短く", "共感寄り", "おまかせ"],
  "画像": ["なし", "1枚", "3枚", "カルーセル案", "おまかせ"],
  "リンク先": ["トップ", "ブログ", "問い合わせ", "このサイトについて", "おまかせ"],
  "やりたいこと": ["サイト修正", "ブログ相談", "X投稿相談", "売り方相談", "不具合確認", "速度/SEO確認", "その他入力"],
};
