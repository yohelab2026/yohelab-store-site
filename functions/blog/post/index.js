...
const FALLBACK_IMAGE = `${SITE_ORIGIN}/yohelab-cat-icon.png`;
...
<head>
  ...
  <link rel="icon" type="image/png" href="/yohelab-cat-icon-32.png" />
...
<body>
  <header class="nav">
    <div class="nav-inner">
      <a class="brand" href="/"><img src="/yohelab-cat-icon.webp" alt="よへラボ" /><span>よへラボ</span></a>
      <nav class="nav-links">
        <a href="/tools/">ツール</a>
