 ...
 *   wrangler r2 object put theme-assets/bunsirube-0.3.0.zip --file=bunsirube-0.3.0.zip
 *   npm run package-child-theme
 *   wrangler r2 object put theme-assets/bunsirube-child-0.1.1.zip --file=bunsirube-child-0.1.1.zip
 */
