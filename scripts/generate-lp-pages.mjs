...
const pages = [
  {
    ...
    name: "3キーワードの記事メーカー",
    title: "3キーワードで記事の材料と下書きを作る | よへラボ",
    description: "3キーワード入力で最新情報を収集し、見出し・FAQ・出典まで整えた記事下書きを生成。無料版は1日1セット、プロプランは月50セット・1,980円。",
    eyebrow: "3キーワードの記事メーカー",
    heroTitle: "3キーワードで、<em>記事の材料と下書き</em>が出る。",
    heroLead: "見出し・FAQ・出典・結論をそろえた構造が、人にも検索にも伝わりやすい。リサーチと記事化を同じ画面で完結させて、1記事あたりの作業を短くする。",
    ...
    freeCards: [
      ...
      { title: "読みやすい構造で出力", text: "見出し・FAQ・結論・出典が自動で入る。人にも検索にも伝わりやすい構造。" },
      { title: "情報を選んで精度を上げる", text: "10〜20件の候補から使う情報を選び、精度の高い記事下書きを生成。" },
    ],
    fitCards: [
      { title: "ブログ・メディア運営者", text: "読者にも検索にも伝わる、構造の整った記事を量産したい人向け。" },
    ...
    proCards: [
      { title: "月50セットで量産できる", text: "記事下書きを月50セット回せる。ブログ・メディア運営の実弾になる量。" },
      { title: "FAQ付きで構造が強い", text: "FAQ・見出し・結論が自動で入る。読者と検索の両方に伝わる型で量産できる。" },
      { title: "リサーチから記事化まで一画面", text: "ツールを行き来するロスがない。収集→選択→記事化を同じ画面で完結。" },
    ],
    faq: [
      ["どんな記事を作れますか？", "ブログ、note、WordPress投稿などの下書きに使える。見出し、FAQ、本文、要約、WordPress設定をまとめて出す。"],
      ["どんな記事が引用されやすい？", "見出し構造・FAQ・結論・出典が明確で、インデックス可能な記事。このツールはその構造を持った下書きを出力する。"],
      ["無料版とプロプランの違いは？", "無料版は1日1セット。プロプランは月50セットまで使えて、見出し・FAQ・出典の整理を強化できる。月1,980円でいつでも解約可能。"],
    ...
    proofShot: {
      ...
      alt: "3キーワードの記事メーカーの画面スクリーンショット",
      label: "3キーワードの記事メーカー",
      title: "3キーワード入れるだけ。見出し・FAQつきの記事が出る。",
      text: "最新情報を収集し、見出し・FAQ・結論・出典の構造を整えた記事下書きを生成。読者にも検索にも伝わる型で出力する。",
      bullets: ["最新情報を自動収集", "読みやすい構造で出力", "FAQ・見出しが自動で入る"],
    },
    voices: [
      { text: "何を整えればいいか分からない時に、見出し・FAQ・出典まで一気に下書きできる。", meta: "メディア運営者" },
      { text: "リサーチと執筆が一つになっているので、記事の骨組みを作る時間を短くできる。", meta: "コンテンツマーケター" },
      { text: "読者にも検索にも読み取りやすい記事構成に寄せたい時の土台になる。", meta: "副業ライター" },
    ],
  },
  {
    slug: "wordpress-theme",
    path: "/lp/bunsirube/",
    name: "記事ブログ用WordPressテーマ",
    title: "記事ブログ用WordPressテーマ ベータ¥5,500 | よへラボ",
    description: "FAQ、構造化データ、内部解析、GA4設定、記事テンプレートを内蔵した軽量WordPressテーマ。プラグインを増やしすぎず、読者にも検索にも伝わる土台を整える。ベータ価格¥5,500（正式版¥8,800）買い切り・月額なし。購入後すぐZIPとシリアルナンバーが届く。",
    eyebrow: "記事ブログ用の軽量WordPressテーマ",
    heroTitle: "プラグインを増やさず、<em>読まれる記事の型</em>を最初から入れる。",
    heroLead: "FAQ、構造化データ、記事テンプレート、内部解析、GA4設定をテーマ側にまとめた。後から設定を積み上げなくても、読者にも検索にも伝わる記事ブログの土台を作れる。",
    ...
    productHref: "/products/bunsirube/",
    proPrice: "5500",
    ...
    proColumnLabel: "購入後",
    proSectionLabel: "Features",
    proSectionTitle: "記事ブログ用テーマで手に入るもの全部",
    ctaTitle: "読まれる記事の土台を、<em>今すぐ整える</em>",
    ...
    freeCards: [
      ...
      { title: "記事テンプレート7種を確認", text: "比較・レビュー・案件紹介・FAQ記事・ランキング・商品紹介の型を事前に確認できる。" },
    ...
    fitCards: [
      ...
      { title: "読まれる記事の土台を最初から整えたい人", text: "llms.txt・構造化データ・FAQ構成を土台から作りたい人向け。後付けよりテーマから整えるほうが早い。" },
    ],
    compareRows: [
      ["機能", "確認できること", "購入後"],
      ["デザイン・レイアウト", "✓", "✓"],
    ...
    faq: [
      ["ベータ版とは？", "現在ベータ版として¥5,500で提供中。WordPress 6.8・PHP 8.0以上で動作確認済み。バグは専用フォームで受け付けて随時修正。正式版リリース後に¥8,800へ価格改定予定。"],
    ...
    proofShot: {
      ...
      alt: "記事ブログ用WordPressテーマの管理画面スクリーンショット",
      label: "記事ブログ用テーマ",
      title: "FAQ・JSON-LD・llms.txtがテーマに入っている",
      text: "管理画面でGA4・GSCを設定し、内部解析でPVを確認。メインカラーと文字色も変えられる。プラグイン追加を抑えて記事ブログの土台を整える。",
