...
const pages = [
  ...
  },
  {
    ...
    title: "AIOに引用されるWordPressテーマ | よへラボ",
    description: "FAQ・構造化データ・AIO向け見出し構造をテーマ側に内蔵。プラグイン不要でAIO対策が完成するWordPressテーマ。3デザイン収録。",
    eyebrow: "AIOに強いWordPressテーマ",
    heroTitle: "プラグイン不要。<em>AIOに引用される構造</em>がテーマに入っている。",
    heroLead: "GoogleのAI概要（AIO）は、FAQ・見出し・構造化データが整ったページを優先して引用する。このテーマはその構造を最初から内蔵している。後付けのプラグインは要らない。",
    ...
    compareHeadline: "無料版で構造を確認、プロプランで3デザインを使い分ける",
    freeCards: [
      { title: "AIO向け構造が最初から入る", text: "FAQ・見出し・構造化データをテーマ側に内蔵。後付け不要。" },
      { title: "1テンプレートで試せる", text: "ミニマルデザインで、AIO対応の土台を確認できる。" },
      { title: "アクセス解析を選べる", text: "テーマ内解析か外部解析かを先に決められる。" },
    ],
    fitCards: [
      { title: "AIO対策を今すぐ始めたい人", text: "プラグインを追加しなくてもAIO向け構造が整う。今すぐ始めたい人向け。" },
      { title: "プラグインを減らしたい人", text: "サイトを軽くしながら、AIO対応・解析・FAQをテーマ側にまとめたい人向け。" },
      { title: "記事サイトとLPを両方作る人", text: "エディトリアル・ミニマル・セールスの3型を用途に合わせて使い分けたい人向け。" },
    ],
    compareRows: [
      ["テンプレート数", "1種（ミニマル）", "3種"],
      ["FAQ・構造化データ", "テーマ内蔵", "テーマ内蔵・強化"],
      ["AIO向け見出し構造", "✓", "✓"],
    ...
    proCards: [
      ...
      { title: "FAQ・構造化をテーマ側に完結", text: "Yoast等のプラグインが不要。テーマだけでAIO対応が完成する。" },
      { title: "AIOに引用される型を量産できる", text: "AIO向けの記事構造がテンプレートとして入っており、量産が楽になる。" },
    ],
    faq: [
      ["AIO対応とは具体的に何が違う？", "FAQ・構造化データ（JSON-LD）・AIO向け見出し順がテーマ側に内蔵されている。通常はプラグインで後付けするものを、テーマに組み込んでいる。"],
      ["Yoast SEOやRank Mathは不要になる？", "FAQ・構造化・メタ情報はテーマ側で管理できる。Yoastなしで運用している利用者も多い。"],
      ["無料版とプロプランの違いは？", "無料版は1テンプレート。プロプランは3種のデザインを使い分けられ、構造化の強化版も使える。"],
      ["いつでも解約できる？", "問い合わせフォームからいつでも解約申請できる。"],
    ],
    proofShot: {
      ...
      label: "AIO対応テーマ",
      title: "FAQ・構造化・見出しが最初から入っている",
      text: "後からプラグインを足す必要がない。テーマ側でAIO対策が完結する設計になっている。",
      bullets: ["FAQ・構造化データを内蔵", "3デザイン収録", "プラグイン不要で軽い"],
    },
    voices: [
      { text: "Yoastなしで動かせるのが驚いた。AIO対策がテーマに入っているから、導入してすぐ記事が引用された。", meta: "ブログ運営・30代" },
      { text: "プラグインを10本以上整理できた。軽くなったし、AIO対応もできてる。一石二鳥だった。", meta: "メディア運営・40代" },
      { text: "3デザインが使い分けられるのがいい。記事サイトとLPで見せ方が変えられる。", meta: "サイト制作・フリーランス" },
    ],
  },
  // x-helper, ec-copy, aio-mini removed — pages deleted
  /*
  {
    slug: "x-helper",
    path: "/lp/x-helper/",
