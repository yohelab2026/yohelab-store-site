...
checks.push(["line webhook supports choice based LINE conversations", lineWebhook.includes("wantsChoices") && lineWebhook.includes("line-choice") && lineWebhook.includes("<!-- line-choice-options:v1 -->") && lineWebhook.includes("AI作業OK 3") && lineWebhook.includes("findLatestChoiceIssue") && lineWebhook.includes("数字だけで選べます") && lineWebhook.includes("ブログ記事を新しく書く") && lineWebhook.includes("X投稿文を作る") && lineWebhook.includes("その他・自由入力で相談する")]);
