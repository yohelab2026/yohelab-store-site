...
checks.push(["dynamic blog posts hide visible title when cover exists", blogPostFunction.includes("const titleHtml = post.eyecatch") && blogPostFunction.includes('<h1 class="sr-only">${escHtml(title)}</h1>') && blogPostPageSource.includes("const titleBlock = post.eyecatch") && blogPostPageSource.includes('class="sr-only"')]);
