...
checks.push(["public llms focuses current bunsirube offer", publicLlms.includes("WordPressテーマ「文標") && publicLlms.includes("サポート範囲") && publicLlms.includes("スマホ幅") && publicLlms.includes("正式版では¥8,800（税込）へ改定予定") && publicLlms.includes("Stripe決済") && publicLlms.includes("GNU GPL v2 or later") && publicLlms.includes("Google AI Overviews等への表示を保証するものではありません") && !publicLlms.includes("初回モニター¥980") && !publicLlms.includes("月額1,980円")]);
