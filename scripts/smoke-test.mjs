...
checks.push(["blog taxonomy pages are included in production build", viteConfig.includes("collectBlogTaxonomyInputs") && existsSync(dist("blog/tag/ai-news/index.html")) && existsSync(dist("blog/category/ai-news/index.html"))]);
...
const homeHasInlineAffiliate = read(dist("index.html")).includes("yohelab_aff") && read(dist("index.html")).includes("/api/checkout?product=wordpress-theme");
...
checks.push(["affiliate signup page has form with required fields", affiliateLp.includes('文標 アフィリエイト') && affiliateLp.includes('購入金額の50%') && affiliateLp.includes('¥2,750') && affiliateLp.includes('¥4,400') && affiliateLp.includes('id="aff-form"') && affiliateLp.includes('name="email"') && affiliateLp.includes('name="site_url"') && affiliateLp.includes('/legal/affiliate-terms/') && affiliateLp.includes('/api/affiliate-signup')]);
...
checks.push(["affiliate ToS lists 50% commission and 30-day attribution", affiliateTerms.includes('50%') && affiliateTerms.includes('2,750') && affiliateTerms.includes('4,400') && affiliateTerms.includes('30日') && affiliateTerms.includes('ラストクリック') && affiliateTerms.includes('禁止事項') && affiliateTerms.includes('ステルスマーケティング') && affiliateTerms.includes('自己購入')]);
...
checks.push(["affiliate lib has stable code generation and stats", affiliateLib.includes('AFFILIATE_COMMISSION_RATE = 0.5') && affiliateLib.includes('AFFILIATE_COMMISSION_AMOUNT') && affiliateLib.includes('BUNSIRUBE_FORMAL_PRICE_JPY') && affiliateLib.includes('getBunsirubePriceJpy') && affiliateLib.includes('makeAffiliateCode') && affiliateLib.includes('hmacBase64Url') && affiliateLib.includes('AFF-')]);
