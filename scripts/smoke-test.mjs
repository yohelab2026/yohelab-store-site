...
checks.push(["lp shows day-by-day transformation timeline", read(dist("lp/bunsirube/index.html")).includes("change-timeline") && read(dist("lp/bunsirube/index.html")).includes("Day 1") && read(dist("lp/bunsirube/index.html")).includes("Day 30") && read(dist("lp/bunsirube/index.html")).includes("AIに拾われても")]);
...
checks.push(["bunsirube lp clarifies sales decision points", bunsirubeLp.includes("AI検索時代、") && bunsirubeLp.includes("いい内容なのに、伝わりにくい") && bunsirubeLp.includes("記事を書く前に必要な部品") && bunsirubeLp.includes("文標は、記事サイトの型") && bunsirubeLp.includes("2026年7月1日から通常価格¥8,800（税込）へ改定します") && bunsirubeLp.includes("決済・返金") && bunsirubeLp.includes("保護された決済画面") && bunsirubeLp.includes("Cocoon") && bunsirubeLp.includes("AFFINGER6") && bunsirubeLp.includes("/legal/privacy/")]);
...
checks.push(["bunsirube lp positions AI-era article structure safely", bunsirubeLp.includes("AI検索時代の記事構造") && bunsirubeLp.includes("記事は構造まで読まれる") && bunsirubeLp.includes("伝わる記事構造") && bunsirubeLp.includes("Google AI Overviews等への表示を保証するものではありません") && !bunsirubeLp.includes("AI検索に出るテーマ") && !bunsirubeLp.includes("AI検索最適化済み") && !bunsirubeLp.includes("AIに拾われる")]);
