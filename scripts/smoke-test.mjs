...
checks.push(["lp research writer avoids hard ROI promises", !lpResearchWriter.includes("圧倒的に安い") && !lpResearchWriter.includes("元が取れる") && !lpResearchWriter.includes("GoogleとAI検索の両方からアクセスが来る") && lpResearchWriter.includes("1セットあたり約39円") && lpResearchWriter.includes("2025年3月19日") && lpResearchWriter.includes("https://www.dentsu.co.jp/knowledge/ad_cost/2024/")]);
...
checks.push(["services uses clear review cta", servicesPage.includes("初回980円でレビューを申し込む") && !servicesPage.includes("Stripeで申し込む")]);
