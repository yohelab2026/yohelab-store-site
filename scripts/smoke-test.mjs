...
checks.push(["theme delivery points to latest package and manifest", themeDownload.includes('key: "bunsirube-0.3.4.zip"') && themeUpdate.includes('\\"version\\": \\"0.3.4\\"') && themeUpdate.includes("/lp/bunsirube/updates/")]);
