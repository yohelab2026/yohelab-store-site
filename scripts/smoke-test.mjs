...
checks.push(["dynamic blog posts share blog header and category tabs", blogPostFunction.includes("renderBlogHeader()") && blogPostFunction.includes("renderBlogCategoryNav(post)") && blogPostFunction.includes("BLOG_CATEGORY_TREE") && blogPostFunction.includes('href: "/blog/category/ai-news/"') && blogPostFunction.includes('href: "/blog/category/home-work/"') && !blogPostFunction.includes('href="/tools/"') && !blogPostFunction.includes('href="/services/"')]);
