...
checks.push(["home focuses bunsirube conversion", home.includes("AIに聞かれる時代に") && home.includes("先行提供") && home.includes("文標の詳細を見る") && home.includes("文標の全機能を見る") && home.includes("購入前に読める確認メモ") && home.includes("AI検索最適化") && home.includes("SEO最適化") && !home.includes("文標で、記事の型を整える。") && !home.includes("無料で遊べるミニゲーム")]);
...
checks.push(["bunsirube lp clarifies sales decision points", bunsirubeLp.includes("文標で何が変わるか、先に見る") && bunsirubeLp.includes("購入後に届くもの") && bunsirubeLp.includes("スマホで読まれる順番も、LP上で先に確認") && bunsirubeLp.includes("2026年7月1日から正式版¥8,800（税込）へ改定します") && bunsirubeLp.includes("決済・返金") && bunsirubeLp.includes("保護された決済画面") && bunsirubeLp.includes("Cocoon") && bunsirubeLp.includes("AFFINGER6") && bunsirubeLp.includes("/legal/privacy/")]);
...
checks.push(["bunsirube demo uses tax-included purchase label", bunsirubeDemo.includes("6月30日まで¥5,500（税込）で購入する") && bunsirubeDemo.includes("2026年7月1日から正式版¥8,800（税込）へ改定します") && bunsirubeDemo.includes("表示価格はすべて税込です。")]);
...
checks.push(["public llms focuses current bunsirube offer", publicLlms.includes("WordPressテーマ「文標") && publicLlms.includes("サポート範囲") && publicLlms.includes("スマホ幅") && publicLlms.includes("2026年7月1日から正式版¥8,800（税込）") && publicLlms.includes("Stripe決済") && publicLlms.includes("GNU GPL v2 or later") && publicLlms.includes("Google AI Overviews等への表示を保証するものではありません") && !publicLlms.includes("初回モニター¥980") && !publicLlms.includes("月額1,980円")]);
