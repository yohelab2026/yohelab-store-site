...
checks.push(["blog category tabs respect parent categories", blogMain.includes("data-parent-category") && blogMain.includes("primaryParentForPost") && blogMain.includes("parentFromCard") && blogMain.includes("return parent === normalized.replace('group:', '')") && blogMain.includes("categoryParentByKey[normalized]")]);
