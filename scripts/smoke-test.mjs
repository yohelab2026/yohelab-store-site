...
checks.push(["line webhook can generate X drafts from selected answers", lineWebhook.includes("buildXDraftFromConversation") && lineWebhook.includes("resolvePromoLink") && lineWebhook.includes("X投稿案（下書き）") && lineWebhook.includes("AI表示や検索順位を保証するものではありません。") && lineWebhook.includes("X投稿案をIssueに追記しました。")]);
