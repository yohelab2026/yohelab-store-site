...
checks.push(["blog eyecatches are not cropped", blogIndexSource.includes("object-fit:contain") && blogPostPage.includes("object-fit:contain") && blogPostFunction.includes("object-fit:contain") && !blogIndexSource.includes("post-card-img {\n      width:100%;height:240px;object-fit:cover") && !blogPostPage.includes("object-fit:cover") && !blogPostFunction.includes("object-fit:cover")]);
