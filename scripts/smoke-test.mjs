...
checks.push(["line webhook has quick replies and relaxed approval words", lineWebhook.includes("quickReply") && lineWebhook.includes("menuQuickReply") && lineWebhook.includes("proceedQuickReply") && lineWebhook.includes("questionQuickReply") && lineWebhook.includes("OK") && lineWebhook.includes("進めて") && lineWebhook.includes("お願い") && lineWebhook.includes("findLatestLineIssue")]);
...
checks.push(["line webhook plans blog images conversationally", lineWebhook.includes("画像タイプは？") && lineWebhook.includes("画像の雰囲気は？") && lineWebhook.includes("画像はどこに入れる？") && lineWebhook.includes("アイキャッチ") && lineWebhook.includes("比較表風")]);
...
checks.push(["line rich menu has six safe actions", lineRichMenuScript.includes('message("ブログ作成", "ブログ")') && lineRichMenuScript.includes('message("リライト", "リライト")') && lineRichMenuScript.includes('message("X投稿", "X投稿")') && lineRichMenuScript.includes('message("営業下書き", "営業下書き")') && lineRichMenuScript.includes('uri("文標LP", "https://yohelab.com/lp/bunsirube/")') && lineRichMenuScript.includes('message("相談", "相談")') && lineWebhook.includes("営業下書き")]);
